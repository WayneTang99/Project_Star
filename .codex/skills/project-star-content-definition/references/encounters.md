...
- 正式数据：`docs/design/ENCOUNTER_DATA.md`（字段与规则）和 `docs/design/EncounterDataTable.csv`（遭遇及其选项）
...
- 新遭遇应生成 `scripts/Content/Encounters/<Name>EncounterDefinition.cs` 及对应 `.cs.uid`，并更新相应 CSV；字段或规则变化时更新 `ENCOUNTER_DATA.md`。

...
| `monster.boar` | 野猪 | 怪物战 | 1～99 | 1 | 1 | 第4回合候选；默认战斗属性，战场第1、2格各放一张独立的1级兽皮，第3～4格放一张1级中型野猪卡；无技能 |
...
怪物战后按损失生命比例结算金币和经验：野猪满额分别为3金币、2经验。胜利时从其两张兽皮和一张野猪卡中按实例等概率抽取一件待领取奖励，因此兽皮与野猪卡的抽取机会为2:1。
